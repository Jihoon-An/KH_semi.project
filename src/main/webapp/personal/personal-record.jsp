...
<main id="personal-record" style="margin-top: 57px">
			...
			<div class="personal_info row">
				...
				<div class="col-5">
					<div class="boundary" id="weight">
						몸무게 변화
						<button type="button" id="btn_weightChange">등록하기</button>
						<div class="chart_wrap">
									...
									<div class="col-7 text-start">
										<form>
											<input type="range" class="form-range" id="reg_range" min="1"
												max="5" style="width: 160px; height: 24px"> <label
												id="reg_range_label"
	...
	<script>
               ...
               let inbodyChart = new Chart(inbodyCtx, {
                  type: 'bar',
                  data: {
                     labels: ['체중', '체지방량', '골격근량', 'BMI'],
                     datasets: [{
                        axis: 'y',
                        label: '# inbody_chart',
                        data: [${list.inbody_weight},${list.inbody_bfm},${list.inbody_sm},${list.inbody_bmi}],
                        backgroundColor: ['rgba(255, 99, 132, 0.2)',
                           'rgba(54, 162, 235, 0.2)',
                           'rgba(255, 206, 86, 0.2)',
                           'rgba(75, 192, 192, 0.2)',
