		...
		<div class="window">
			...
			<form id="form_sign">
				<div class="row justify-content-center">
					...
					<div class="col-12 gy-3" style="font-size: small; letter-spacing : -1px;">
...
<script>
        ...
        $("#btn_sign").on("click", () => {
            ...
            else if ($("#users_phone_msg").css("color") == "rgb(255, 0, 0)") { wobble($("#users_phone")[0]); $("#users_phone").focus(); }
            else {
        ...
        function pwEvent() {
            if ($("#users_pw, #users_pw_re").val() == "") {
                ...
                if (!pwRegex.test($("#users_pw").val())) {
                    ...
                    console.log("패스워드 : " + $("#users_pw").val());
                    console.log("패스워드확인 : " + $("#users_pw_re").val());
        ...
        function phoneEvent() {
            ...
            } else if (!phoneRegex.test($("#users_phone").val())) {
                $("#users_phone_msg").css("display", "block");
